...
async function handleRequest(request) {
  ...
  if (res) {
    return new HTMLRewriter().on('head', new ElementHandler(googleAnalytics)).transform(res)
  }
  ...
  return new HTMLRewriter().on('head', new ElementHandler(googleAnalytics)).transform(response)
}
